...
/**
 * This is the Class which will generate frames for handling customers in the
 * database.It is controlled by instances of ClientAdmin.
 */
@SuppressWarnings("serial")

public class CustomerView extends JFrame {
	private JLabel idLabel = new JLabel("CustomerID ");
